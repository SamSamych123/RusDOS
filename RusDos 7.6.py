...
Команда помощь - предъевляет команды
...
Команда чат-бот - это бот, с которым можно разговаривать
Команда игры - можно поиграть в игры
Команда время - показывает время в вашу секунду с точностью
Команда открыть программу №1 - может открыть системную программу в Windows
Команда выход - выходит из системы RusDos
Команда погода - показывает погоду на ближайшие 2 часа
...
''')
    while True:
        ...
        if a == "калькулятор":
            ...
            print("Версия RusDos (Russia Disk Operation System) 7.6. Все права (Пользвательские и Авторские) защищены. RusDos - это эмулятор\симулятор MS - DOS, x86 DOS и другие. Но они не как не имеют с этим творением ничего общего.")
        elif a == "блокнот":
            ...
            while True:
                ...
                elif c == "к меня всё хорошо":
                    print("Отлично! Чем занимаетесь?")
                elif c == "с тобой разговаривариваю":
                    print("Понятно.")                    
                elif c == "пока":
                    print("Досвидание!")
                    break
...
''')
            ...
            b = input("Что вы хотите сделать (прочитать слот(Прочитать) или написать там чтото в дополнение(Написать)(На заметку: если вы хотите сделать другую стоку, то НЕ НАЖИМАЙТЕ НА ENTER!). Введите решение в поле ввода: ")
            if b == "Написать":
                b21 = input("Выберете слот (от 1 до 10): ")
                b31 = input("")
                if b21 == "1":
...
Команда Выход - выходит из системы RusDos
Команда Погода - показывает погоду на ближайшие 2 часа
(Внимание: если вы написали команду, а она у вас не выполнелась, то значит вы допустили ошибку! Для выполнения команды, надо либо скопировать команду, либо написать её правильно.)
...
''')
            ...
            print("Извините, но вы ввели неправильную команду.")
elif x1 == "English":
     print(''' SSSSSSSSSSS
  SS
 SS
...
''')
    ...
    print("Вы ввели неправильно язык/You enter other language")
